...
class TinTucController extends Controller
{
    ...
    public function postThem(Request $request)
    {
        ...
        if($request->hasFile('Hinh'))
        {
            ...
            {
                return redirect('admin/tintuc/them')->with('thongbao','Vui lòng chọn lại file có đuôi jpg,png,jpeg');
            }
    ...
    public function postSua(Request $request, $id){
        ...
        $tintuc->save();
        return redirect('admin/tintuc/danhsach')->with('thongbao','Sửa tin thành công');
    }
