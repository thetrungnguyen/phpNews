            ...
            <div class="col-md-12">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        @foreach($slide as $sl)
                        <div class="item<?php if($sl->id == 1) echo " active"?>">
                            <img class="slide-image" src="upload/images/{{$sl->Hinh}}" alt="">
                        </div>
                        @endforeach
    ...
    <div class="col-md-9">
        <div class="panel panel-default">            
            <div class="panel-heading" style="background-color:#337AB7; color:white;" >
                <h2 style="margin-top:0px; margin-bottom:0px;">TIN TỨC NÓNG HỔI</h2>
            </div>
